...
- [-] 1. Project setup and data ingestion
  ...
  - [x] 1.3 Write unit tests for Data_Loader
...
- [-] 2. Eligible player filtering and base stat calculation
  ...
  - [x] 2.4 Write unit tests for Stat_Calculator base stats
...
- [-] 3. Court geometry module
  - [x] 3.1 Implement `CourtConfig` dataclass and zone taxonomy
  ...
  - [x] 3.2 Implement `corner3_eliminated()` geometric derivation
  ...
  - [x] 3.3 Implement zone boundary derivation per `CourtConfig`
  ...
  - [x] 3.4 Write property test for Corner_3_Elimination_Condition
  ...
  - [x] 3.5 Write unit tests for court geometry
...
- [x] 5. Per-player per-zone stats and sparse zone logic
  ...
  - [x] 5.3 Write property test for sparse zone logic
  ...
  - [x] 5.4 Write unit tests for zone stats and sparse logic
...
- [-] 6. Neural Network model
  - [x] 6.1 Implement `Neural_Network_Model` architecture
  ...
  - [x] 6.2 Implement NN training pipeline
  ...
  - [x] 6.3 Implement NN inference for heatmap generation
  ...
  - [x] 6.4 Fit per-player KDE for shot location sampling
...
- [-] 7. Gradient Boost model
  - [x] 7.1 Implement GB feature engineering
  ...
  - [x] 7.2 Implement GB model training
  ...
  - [x] 7.4 Write property test for Gradient Boost model
  ...
  - [x] 7.5 Write unit tests for Gradient Boost model
...
- [-] 9. Heatmap Engine
  - [x] 9.1 Implement historical heatmap generation
  ...
  - [x] 9.2 Implement heatmap rendering and side-by-side display
  ...
  - [x] 9.3 Implement new court heatmap generation for combined-optimal config
  ...
  - [x] 9.4 Implement zone reclassification and shot value update per Court_Config
  ...
  - [x] 9.5 Write unit tests for Heatmap Engine
...
- [-] 10. Game Simulator
  - [x] 10.1 Implement shot attempt allocation
  ...
  - [x] 10.2 Implement NN-weighted KDE shot location sampling
  ...
  - [x] 10.4 Implement shot outcome simulation
  ...
  - [x] 10.5 Implement per-game tracking and 100-game simulation loop
  ...
  - [x] 10.7 Write unit tests for Simulator
...
- [-] 12. Grid search and Optimizer
  - [x] 12.1 Implement grid search enumeration
  ...
  - [x] 12.2 Implement per-config execution loop
  ...
  - [x] 12.3 Implement result storage
  ...
  - [x] 12.4 Implement `top5_with_ties` ranking
  ...
  - [x] 12.5 Write property test for Optimizer ranking
  ...
  - [x] 12.6 Write unit tests for Optimizer
...
- [-] 13. Output formatting and final integration
  - [x] 13.1 Implement final output formatter
  ...
  - [x] 13.2 Implement per-player stats output per config
    - For the combined-optimal config, print per-player: PPG, 3PT%, 3PA per game
    - _Requirements: 11.2_

  - [x] 13.3 Wire all components into `main.py` end-to-end pipeline
