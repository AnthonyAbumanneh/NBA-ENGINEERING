...
def print_results(
    ...
    _print_top5_section("Pacers-Optimal", cavs_top5, "cavs_3pt_pct")
    _print_top5_section("Thunder-Optimal", warriors_top5, "warriors_3pt_pct")
...
def _print_historical_baseline(warriors_3pt: float, cavs_3pt: float) -> None:
    ...
    print("=" * 60)
    print(f"  Thunder 3PT%:   {warriors_3pt * 100:.1f}%")
    print(f"  Pacers 3PT%:    {cavs_3pt * 100:.1f}%")
    print()
...
def _print_best_court(
    ...
    print(f"  Pacers 3PT%:           {cavs_pct:.1f}%")
    print(f"  Thunder 3PT%:          {warriors_pct:.1f}%")
